      ...
      <div className="tactile-card rounded-3xl p-6 sm:p-8 bg-white border border-[#E3E2E0] shadow-sm">
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
          <div className="relative shrink-0">
            ...
            />
            <label
              className="absolute -bottom-1 -right-1 w-9 h-9 rounded-full bg-[#8E4E14] text-white flex items-center justify-center border-2 border-white shadow-sm cursor-pointer hover:bg-[#6F3800] transition-all"
